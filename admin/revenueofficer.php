...
if (isset($_POST["add"])) {
    ...
    $phone = $_POST["phone"];
    $ql = $_POST["ql"];
    $rev_id = "REV_OFF-" . date("ymdis");

    $insert_record = mysqli_query($conn, "insert into rev_officer values ('$rev_id','$fullname','$email','$phone','$ql')");
    if ($insert_record) {
        $insert_login = mysqli_query($conn, "insert into login values ('$phone','$phone','revoff')");
        if ($insert_login) {
            $_SESSION["phone"]=$phone;
            echo "<script>alert('Registration Successfull'); window.location.href='get-qrcode.php'</script>";
        } else {
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">REVENUE OFFICERS</span>
                                ...
                                <form method="POST" action="" role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required="" name="ql" class="form-control">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $result = mysqli_query($conn, "select * from rev_officer");
                                            $a = 1;
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a onclick="return confirm()" href="revenueofficer.php?id=<?php echo $row["email"]; ?>" class="btn btn-primary">REMOVE OFFICER</a></td>                                                    
                                                </tr>
                                                <?php
                                                $a++;
                                            }
